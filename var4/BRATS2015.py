...
#%%
# catch all T1c.mha
create_data('/mnt/hgfs/Medical-Data/BRATS-2015/BRATS2015_Training/HGG/', '**/*Flair*.mha', label=False, resize=(155,img_size,img_size))
create_data('/mnt/hgfs/Medical-Data/BRATS-2015/BRATS2015_Training/HGG/', '**/*OT*.mha', label=True, resize=(155,img_size,img_size))
